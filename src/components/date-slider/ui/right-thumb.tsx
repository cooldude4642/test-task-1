...
export function RightThumb ({
	...
	return (
		<>
			...
			/>
			<div
				className='z-20 w-32 absolute bottom-[-18px]'
			...
			>
				...
				>
					<span className='z-10 w-[16px] h-[16px] rounded-[2px] bg-[#FFFFFF] absolute -top-1 transform rotate-45'/>
